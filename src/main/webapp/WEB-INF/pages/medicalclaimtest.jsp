...
<body>
  ...
  <form:form action="saveclaimstatement" method="post" modelAttribute="claimstatement">
	...
	<div class="row" style="padding-left: 100px;padding-right: 100px;margin-top: 50px">
            <div class="panel panel-primary">    
                  ...
                  <div class="panel-heading">
                        <h3 class="panel-title" style="text-align: center">Cost of X-ray, ECG, EEG, USG, Pathological tests, and other tests</h3>
                    </div>         
		...
		<table class="table table-bordered" style="border-width: 2px">
			...
			<th>Total</th>
				...
				<tr>
					     ...
					     <form:hidden path="id"/>
					     <form:hidden path="claimtype" name="claimtype" value="labtestFee"/>
	...
	<c:forEach items="${list}" var="claimstatement">
		<tr>
			  		  <td  style="border-color: navy;"><input type="text" style="border:none; " value="${claimstatement.billrefno}"  /></td>
					  <td style="border-color: navy;"><input type="text" style="border:none; " value="${claimstatement.description}"/></td>
					  <td style="border-color: navy;"><input type="text" style="border:none; " value="${claimstatement.amoount}" /></td>
					  <td style="border-color: navy;"><input type="text" style="border:none; " value="${claimstatement.total}" /></td>
					  <td style="border-color: navy;"><center>
					  <a href="#" style="margin-right: 20px">Edit</a>
	...
	<div>
		<button type="submit" name="next" class="btn btn-primary pull-right" style="width: auto;">Submit</button>
		</div>
