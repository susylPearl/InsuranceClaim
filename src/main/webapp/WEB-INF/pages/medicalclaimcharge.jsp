	...
	<div class="row" style="padding-left: 100px;padding-right: 100px;margin-top: 50px">
            <div class="panel panel-primary">    
               ...
               <div class="panel-heading">
                        <h3 class="panel-title" style="text-align: center">Cost of medicine, medical appliances, dressing charge etc.</h3>
                    </div>     
		...
		<table class="table table-bordered" style="border-width: 2px">
			...
			<th>Total</th>
				...
				<tr>
					     ...
					     <form:hidden path="id"/>
					     <form:hidden path="claimtype" name="claimtype" value="medicineFee"/>
