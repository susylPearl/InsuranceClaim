...
<body>
	...
	<div class="row"
		...
		<div class="panel panel-primary">
			...
			<form:form
				action="/InsuranceMedicalClaim/detailClaimDoctorHomeVisitReport"
				method="GET">
				...
				<div class="row">
					...
					<div class="col-lg-2">
						<button class="btn btn-success" align="right" value="Submit"
							name="next" id="next">Next</button>
