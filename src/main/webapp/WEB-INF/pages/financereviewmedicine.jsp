			...
			<div class="panel panel-primary">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title" style="text-align: center">Medicine
							Fee</h3>
					</div>
				</div>
...
<form:form action="/InsuranceMedicalClaim/detailClaimLabTestReport">
	<div class="row"
		style="padding-left: 100px; padding-right: 100px; margin-top: 50px">
		<div class="panel panel-primary">
	...
	<div class="row">
		...
		<div class="col-lg-2">
			<button class="btn btn-success" align="right" value="Submit" name="next" id="next">Next</button>
