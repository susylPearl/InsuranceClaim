	...
	<div class="row" style="padding-left: 100px;padding-right: 100px;margin-top: 50px">
            <div class="panel panel-primary">    
                      ...
                      <div class="panel-heading">
                        <h3 class="panel-title" style="text-align: center">Doctor/physician/specialist's fees for visit to the patient at home</h3>
                    </div>    
		...
		<table class="table table-bordered" style="border-width: 2px">
			...
			<th>Total</th>
				...
				<tr>
					     ...
					     <form:hidden path="id"/>
					     <form:hidden path="claimtype" name="claimtype" value="doctorsHomeFee"/>
	...
	<c:forEach items="${list}" var="claimstatement">
		<tr>
					 ...
					 <!--  <a href="#" style="margin-right: 20px">Change</a> -->
					  ...
					  <a href="<c:url value='/editStatemnet/${claimstatement}'/>">Change</a>
